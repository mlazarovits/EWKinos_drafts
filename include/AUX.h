...
// Sat May 11 18:46:52 2019 by ROOT version 6.10/09
// from TTree AUX/AUX
// found on file: TTJets/stopFlatNtuples_101.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("TTJets/stopFlatNtuples_101.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("TTJets/stopFlatNtuples_101.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("TTJets/stopFlatNtuples_101.root:/stopTreeMaker");
