...
// Tue Jun 11 16:25:35 2019 by ROOT version 6.14/00
// from TTree KUAnalysis/KUAnalysis
// found on file: WJetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8_Fall17.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("WJetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8_Fall17.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("WJetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8_Fall17.root");
      }
