...
// Mon Sep 30 16:43:04 2019 by ROOT version 6.10/09
// from TTree Events/Events
// found on file: ../prod2017MC_NANO_1025.root
//////////////////////////////////////////////////////////

#ifndef prod2017MC_reducedNANO_Triggers_h
#define prod2017MC_reducedNANO_Triggers_h
...
class prod2017MC_reducedNANO_Triggers {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   prod2017MC_reducedNANO_Triggers(TTree *tree=0);
   virtual ~prod2017MC_reducedNANO_Triggers();
...
#ifdef prod2017MC_reducedNANO_Triggers_cxx
prod2017MC_reducedNANO_Triggers::prod2017MC_reducedNANO_Triggers(TTree *tree) : fChain(0) 
{
...
prod2017MC_reducedNANO_Triggers::~prod2017MC_reducedNANO_Triggers()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t prod2017MC_reducedNANO_Triggers::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t prod2017MC_reducedNANO_Triggers::LoadTree(Long64_t entry)
{
...
void prod2017MC_reducedNANO_Triggers::Init(TTree *tree)
{
...
Bool_t prod2017MC_reducedNANO_Triggers::Notify()
{
...
void prod2017MC_reducedNANO_Triggers::Show(Long64_t entry)
{
...
Int_t prod2017MC_reducedNANO_Triggers::Cut(Long64_t entry)
{
...
#endif // #ifdef prod2017MC_reducedNANO_Triggers_cxx
