...
// Thu Sep 19 11:17:18 2019 by ROOT version 6.10/09
// from TTree Events/Events
// found on file: prod2016MC_NANO_1.root
//////////////////////////////////////////////////////////

#ifndef prod2016MC_reducedNANO_Triggers_h
#define prod2016MC_reducedNANO_Triggers_h
...
class prod2016MC_reducedNANO_Triggers {
public :
...
//   TBranch        *b_run;   //!
 ...
 //  TBranch        *b_HLT_DoubleMu4_PsiPrimeTrk_Displaced;   //!
   ...
   prod2016MC_reducedNANO_Triggers(TTree *tree=0);
   virtual ~prod2016MC_reducedNANO_Triggers();
...
#ifdef prod2016MC_reducedNANO_Triggers_cxx
prod2016MC_reducedNANO_Triggers::prod2016MC_reducedNANO_Triggers(TTree *tree) : fChain(0) 
{
...
prod2016MC_reducedNANO_Triggers::~prod2016MC_reducedNANO_Triggers()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t prod2016MC_reducedNANO_Triggers::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t prod2016MC_reducedNANO_Triggers::LoadTree(Long64_t entry)
{
...
void prod2016MC_reducedNANO_Triggers::Init(TTree *tree)
{
...
Bool_t prod2016MC_reducedNANO_Triggers::Notify()
{
...
void prod2016MC_reducedNANO_Triggers::Show(Long64_t entry)
{
...
Int_t prod2016MC_reducedNANO_Triggers::Cut(Long64_t entry)
{
